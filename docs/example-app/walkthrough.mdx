...
description: "Guided tour of every panel in the sample app, with screenshots."
---
...
<Note>
Screenshots below live in `docs/images/walkthrough/`. The deployed demo may differ slightly if this doc lags behind `main`.
</Note>
...
<Frame caption="Live ADA/USD hero. Fresh means the datum is inside its 5-minute validity window.">
  <img src="/images/walkthrough/hero.png" alt="Hero price block showing $0.324812 per ADA" />
</Frame>
...
<Frame caption="The three-step loop. Each step lands a tx on preprod.">
  <img src="/images/walkthrough/run-the-loop.png" alt="Deposit, Refresh, Claim panel" />
</Frame>
...
<Frame caption="The agent panel gates behind Lace. No chat until the wallet is connected.">
  <img src="/images/walkthrough/agent-gate.png" alt="Connect Lace gate" />
</Frame>
...
<Frame caption="Tool-call timeline: read price, refresh if stale, validate address, propose payment.">
  <img src="/images/walkthrough/agent-trace.png" alt="Tool-call thought process with Cardanoscan link" />
</Frame>
...
<Frame>
  <img src="/images/walkthrough/code-compare.png" alt="Python SDK vs charli3-js side by side" />
</Frame>
